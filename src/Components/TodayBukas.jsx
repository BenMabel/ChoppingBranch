...
const TodaysBukasList = ({bukasData}) => {
    return (
        <div className="slides">
            {bukasData.map((bukaData) => (
                <TodayBukas img={bukaData.img} price={bukaData.price} title={bukaData.title} />
            ))}
...
export default TodaysBukasList